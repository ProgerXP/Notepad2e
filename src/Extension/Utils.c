...
void n2e_UpdateToolbarButtons()
{
  ...
  static LPCWSTR s_defaultToolbarConfiguration[] = {
    ...
    L"1 2 22 25 24 4 27 0 5 6 0 7 8 9 0 10 21 -239 0 28 29 30 0 12 31 -274 26 0 13",    // R261-...
    L"1 2 22 25 24 4 27 0 5 6 0 7 8 9 0 10 21 -239 0 28 29 30 0 12 31 -274 26 0 13 14", // f4e24dc
  };
